...
namespace pdft
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            pr.SaveReport(Environment.CurrentDirectory + @"\Report.pdf");
        }
    }
    ...
    public class PDFReport
    {
        ...
        private BaseFont baseFont = BaseFont.CreateFont(Environment.CurrentDirectory + @"\arial.ttf", BaseFont.IDENTITY_H, true);
        ...
        void WriteAlgorithmStep(iTextSharp.text.Document doc)
        {
            doc.Add(new Paragraph(new Chunk("State name", new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.TIMES_ROMAN, 16, iTextSharp.text.Font.ITALIC, iTextSharp.text.BaseColor.GREEN))));
        ...
        void AddImage(Document doc)
        {
            Image logo = Image.GetInstance(@"C:\Users\Arsslen\Pictures\Camera Roll\WIN_20171204_16_57_11_Pro.jpg");
        ...
        void WriteAlgorithmBenchmark(iTextSharp.text.Document doc, string algorithm)
        {
            ...
            iTextSharp.text.Chunk linebreak = new iTextSharp.text.Chunk(line);
            Chunk c = new Chunk(algorithm, new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.TIMES_ROMAN, 24, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLUE));
            c.SetGenericTag(algorithm);
            doc.Add(new Paragraph(c));
            // algorithm description
            Chunk desc = new Chunk("description", new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.TIMES_ROMAN, 12, iTextSharp.text.Font.ITALIC, iTextSharp.text.BaseColor.BLACK));
            doc.Add(new Paragraph(desc));
            
            // write steps
            WriteAlgorithmStep(doc);
            WriteAlgorithmStep(doc);
            doc.NewPage();
        }
        void WriteDocument(iTextSharp.text.Document doc)
        {
            doc.AddCreationDate();
            ...
            WriteAlgorithmBenchmark(doc, "BFS");
            WriteAlgorithmBenchmark(doc, "DFS");
